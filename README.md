# Group 9 React YouTube Clone Project

This React application lets you search for YouTube videos using the YouTube API, then choose a video from a list to watch.
